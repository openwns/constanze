...
#include <CONSTANZE/GeneratorARMA.hpp>
...
STATIC_FACTORY_REGISTER_WITH_CREATOR(constanze::GeneratorARMA, constanze::GeneratorBase, "ARMA", wns::PyConfigViewCreator);

/*************************** Generator *******************************/

GeneratorARMA::GeneratorARMA( const wns::pyconfig::View& config) :
...
void GeneratorARMA::stateChangeNotification(const int &chainNumber) {
