...
#ifndef CONSTANZE_TCPCLIENTLISTENERBINDING_HPP
#define CONSTANZE_TCPCLIENTLISTENERBINDING_HPP
...
namespace constanze
{
	class TcpClientListenerBinding:
		public Binding,
		public wns::service::tl::ConnectionHandler,
		public wns::service::tl::DataHandler
	{
	public:
		TcpClientListenerBinding(int _listenPort);
		virtual ~TcpClientListenerBinding() {};

		void
		registerTcpService(wns::service::tl::Service* _tcpService);
