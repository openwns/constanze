...
#ifndef CONSTANZE_TCPLISTENERBINDING_HPP
#define CONSTANZE_TCPLISTENERBINDING_HPP
...
namespace constanze
{
	class TcpServerListenerBinding:
		public Binding,
		public wns::service::tl::ConnectionHandler,
		public wns::service::tl::DataHandler
	{
	public:
		TcpServerListenerBinding(const wns::pyconfig::View& _pyco);
		virtual ~TcpServerListenerBinding();
